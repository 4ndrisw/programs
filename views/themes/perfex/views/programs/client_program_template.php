...
<div id="wrapper">
    <div class="content">
        <div class="row">
            ...
            <div class="panel_s client-template program">
               <div class="panel-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6 border-right">
                        ...
                        <div class="form-group select-placeholder inspector_staffs-wrapper<?php if((!isset($program)) || (isset($program) && !customer_has_inspector_staffs($program->clientid))){ echo ' hide';} ?>">
                         <label for="inspector_staff_id"><?php echo _l('inspector_staff'); ?></label>
                         <div id="inspector_staff_ajax_search_wrapper">
                           <select name="inspector_staff_id" id="inspector_staff_id" class="inspector_staffs ajax-search" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                            <?php
                              if(isset($program) && $program->inspector_staff_id != 0){
                                echo '<option value="'.$program->inspector_staff_id.'" selected>'.get_inspector_staff_name_by_id($program->inspector_staff_id).'</option>';
                              }
                            ?>
                          </select>
                        </div>
                    ...
                    <div class="col-md-12 mtop15">
                      <div class="panel-body">
                           <div class="row">
                              <div class="col-md-6">
                                    <div class="form-group select-placeholder inspector_staffs-wrapper">
                                       <label for="inspector_staff_id"><?php echo _l('inspector_staff'); ?></label>
                                       <div id="inspector_staff_ajax_search_wrapper">
                                           <select name="inspector_staff_id" id="inspector_staff_id" class="inspector_staffs ajax-search" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                            <?php
